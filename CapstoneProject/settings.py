...
SECRET_KEY = 'django-insecure-ydi3sn5^_1v6npr8g=#(h@a*+l%4##!4g2o&j19&jqqng1k5$y'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'static', 'capstone-cra', 'build'),
                 os.path.join(BASE_DIR / 'templates')], # 원래는 'DIRS': [BASE_DIR / 'templates']
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
