...
def Statistics(request):
    ...
    if request.method == 'GET':
        ...
        if validate_token(request):
            ...
            for date, pro in aggregated_data['pro'].items():
                data['pro'].append({'x': date, 'y': pro})
            for date, carbon in aggregated_data['carbon'].items():
                data['carbon'].append({'x': date, 'y': carbon})
            for date, fat in aggregated_data['fat'].items():
                data['fat'].append({'x': date, 'y': fat})
